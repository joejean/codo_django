...
patterns('',
         ...
         url(r'^campaigns/$', views.AllCampaignsList.as_view(), name='all_campaigns_list'),
         url(r'^my_campaigns/$', login_required(views.UserCampaignsList.as_view()), name='user_campaigns_list'),
